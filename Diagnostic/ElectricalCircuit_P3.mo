...
equation
  ...
  equation
   ...
   //   ex1.s2.state = PhysicalFaultModeling.FaultType.ok;
   //   ex1.s2.mode = PhysicalFaultModeling.OperationalMode.open;
   //   ex1.r_load.percentage = 5;
    else
      ex1.s2.state = PhysicalFaultModeling.FaultType.close;
      ex1.s2.mode = PhysicalFaultModeling.OperationalMode.open;
      ex1.r_load.percentage = 10;
    end if;
    annotation(
      experiment(StartTime = 0, StopTime = 0.6, Tolerance = 1e-06, Interval = 0.0001));
  end P3Ex1_Testbench_7;
